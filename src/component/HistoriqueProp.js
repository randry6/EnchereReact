...
class HistoriqueProp extends Component{
    ...
    componentDidMount(){
        HistoriqueUserService.getHistoriquebyProp(this.state.id).then((res) =>{
        ...
        return(
            <><div>
                ...
                <div class="text-center">
                    <h1>Liste de vos propres enchères</h1>
                </div>
                <br /><br />
                <div class="container">
                                ...
                                <div class="card-header border-bottom-0 pt-7 pb-5" key={list.enchere.idenchere}>
                                    ...
                                    <div class="card-body mx-auto">
                                        <ul class="list-unstyled mb-4">
                                            ...
                                            <li class="text-700 py-2 text-secondary">pour un prix de {list.enchere.mise} Ariary</li>
