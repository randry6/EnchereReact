...
import HistoriqueUserService from '../services/HistoriqueUserService';

class HistoriqueUser extends Component{
    ...
    componentDidMount(){
        HistoriqueUserService.getHistoriqueByUSer(this.state.id).then((res) =>{
            ...
            <><div>
                <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" data-navbar-on-scroll="data-navbar-on-scroll">
                    <div class="container"><a class="navbar-brand d-flex align-items-center fw-bold fs-2" href="index.html">
                        ...
                        <button class="btn btn-lg btn-primary rounded-pill order-0" type="button">Déconnection</button>
                    </div>
                </nav>
            </div><><section class="py-8" id="pricing">
                <div class="text-center">
                    <h1>Historiques des mises sur vos propres enchères</h1>
                </div>
                <br/><br/>
                <div class="container">
                    ...
                    <div class="row">
                        {
                            this.state.historique.map(
                                ...
                                <div class="card-header border-bottom-0 pt-7 pb-5" key={list.enchere.idenchere}>
                                        <div class="d-flex justify-content-center">
                                            <img src={list.enchere.image} width="300"/>
                                    ...
                                    <div class="card-body mx-auto">
                                        <ul class="list-unstyled mb-4">
                                            <li class="text-700 py-2 text-secondary"><h1 class="fw-bold">{list.enchere.categorie.designation} {list.produit}</h1></li>
                                            <li class="text-700 py-2 text-secondary"> mis en vente le {list.enchere.dateMise}  </li>
                                            <li class="text-700 py-2 text-secondary">Miser pour: {list.prix} Ariary</li>
                                            <li class="text-700 py-2 text-secondary">Par: {list.user.nom} {list.user.prenom}</li>
                                            <li class="text-700 py-2 text-secondary">Fin d'expiration le {list.enchere.fin} heures</li>
                                        </ul><a class="btn btn-lg btn-primary rounded-pill mb-3" href={`/enchereById?idenchere=${list.enchere.idenchere} `}>Voir plus</a>
                                    </div>
