...
class EnchereEncoursComponent extends Component{
    constructor(props){
        super(props)
    ...
    componentDidMount(){
        EnchereService.getEnchereEncours().then((res) =>{
            this.setState({enchereencours: res.data})
        });
    }
        ...
        return(
            <><div>
                ...
                <div class="text-center">
                    <h1>Listes des encheres encore encours</h1>
                </div>
                <br/><br/>
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        {this.state.enchereencours.map(
                            list => <div class="col-lg-4">
                                ...
                                <div class="card-header border-bottom-0 pt-7 pb-5" key={list.idenchere}>
                                    ...
                                    <div class="card-body mx-auto">
                                        <ul class="list-unstyled mb-4">
                                            ...
                                            <li class="text-700 py-2 text-secondary"><h1 class="fw-bold">{list.categorie.designation} {list.produit}</h1></li>
                                            <li class="text-700 py-2 text-secondary"> mis en vente le {list.dateMise}  </li>
                                            <li class="text-700 py-2 text-secondary">pour un prix de {list.mise} Euro</li>
                                            <li class="text-700 py-2 text-secondary">Fin d'expiration le {list.fin} heures</li>
                                        </ul><a class="btn btn-lg btn-primary rounded-pill mb-3" href={`/enchereById?idenchere=${list.idenchere} `}>Voir plus</a>
                                    </div>
...
export default EnchereEncoursComponent